...
`final_report.md`의 자동 점수표에서 10개 카테고리 점수가 모두 90점 이상이면 완료로 본다.

## 문서 작성 준수 확인

- [ ] AI 텍스트 티 제거: (예/아니오)
- [ ] 근거 파일/명령/수치 연결: (예/아니오)
- [ ] 과장형·추측형 표현 제거: (예/아니오)

## 문서화 기본 규칙

이 저장소에서 작성되는 문서는 한글을 기본으로 한다.
주석·코드·숫자 단위는 그대로 사용한다.
문장 단위로 “무엇을 했는지, 근거는 무엇인지, 결과는 무엇인지”를 적는다.
